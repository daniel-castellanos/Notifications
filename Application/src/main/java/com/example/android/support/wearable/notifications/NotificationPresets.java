...
public class NotificationPresets {
    ...
    private static class BigPictureNotificationPreset extends NotificationPreset {
        ...
        public Notification[] buildNotifications(Context context, BuildOptions options) {
            ...
            style.bigPicture(BitmapFactory.decodeResource(context.getResources(),
                    R.drawable.smart_watch_background));
            style.setBigContentTitle(context.getString(R.string.big_picture_title));
            ...
            String title = "Karen's Wishlist";
            String content = "Category: Carpet\n" +
                    "Brand: StainFree\n" +
                    "Color: Shifting Sand\n" +
                    "Price: $1.17 per sqft\n" +
                    "Material/Fiber: Olefin";

            wearableOptions.addPage(newPage(title, content, context, R.drawable.bg_wear_carpet));

            title = "Related item";
            content = "Category: Carpet Padding\n" +
                    "Weight (lbs): 1.93\n" +
                    "Thickness (mm): 12.7\n" +
                    "Material: Rebond\n" +
                    "Price: $0.68 per sqft";

            wearableOptions.addPage(newPage(title, content, context, R.drawable.bg_wear_carpet_padding));
    ...
    private static Notification newPage(String title, String content, Context context, int iconId){
